...
public class WednesdayMenu extends AppCompatActivity {

    private ProgressDialog pDialog;

    HashMap<String, String> wednesdaymenuHashMap;        //new

    // JSON Node names
    private static final String TAG_WEDNESDAY = "wednesdaymenu";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wednesday_menu);
    ...
    private class GetContacts extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(WednesdayMenu.this);
        ...
        protected Boolean doInBackground(Void... arg0) {
            ...
            String url = "http://dcafe-menu.getsandbox.com/dcafe-menu-wednesday";
            ...
            if (jsonStr != null) {
                ...
                try {
                    ...
                    wednesdaymenu = jsonObj.getJSONArray(TAG_WEDNESDAY);
                    Log.d("check 12 : ", "" +wednesdaymenu  );

                    wednesdaymenuHashMap = new HashMap<String, String>();
                    // looping through All Contacts
                    for (int i = 0; i < wednesdaymenu.length(); i++) {
                        JSONObject c = wednesdaymenu.getJSONObject(i);
                        ...
                        {
                            wednesdaymenuHashMap.put(TAG_DRY_CEREAL, DRY_CEREAL);
                            //Log.d("check  : ", "" +TAG_DRY_CEREAL  );
                        }
                        //wednesdaymenu.put(TAG_DRY_CEREAL, DRY_CEREAL);

                        // wednesdaymenu.put(TAG_DRINK_ONE, DRINK_ONE);

                        if (DRINK_ONE!=null&&!DRINK_ONE.isEmpty())

                        {
                            wednesdaymenuHashMap.put(TAG_DRINK_ONE, DRINK_ONE);
                            //Log.d("check  : ", "" +TAG_DRY_CEREAL  );
                        }

                        //wednesdaymenu.put(TAG_DRINK_TWO, DRINK_TWO);
                        if (DRINK_TWO!=null&&!DRINK_TWO.isEmpty())

                        {
                            wednesdaymenuHashMap.put(TAG_DRINK_TWO, DRINK_TWO);
                            //Log.d("check  : ", "" +TAG_DRY_CEREAL  );
                        }

                        // wednesdaymenu.put(TAG_MAIN, MAIN);
                        if (MAIN!=null&&!MAIN.isEmpty())

                        {
                            wednesdaymenuHashMap.put(TAG_MAIN, MAIN);
                            //Log.d("check  : ", "" +TAG_DRY_CEREAL  );
                        }
                        // wednesdaymenu.put(TAG_ACCOMPANIMENT, ACCOMPANIMENT);
                        if (ACCOMPANIMENT!=null&&!ACCOMPANIMENT.isEmpty())

                        {
                            wednesdaymenuHashMap.put(TAG_ACCOMPANIMENT, ACCOMPANIMENT);
                            //Log.d("check  : ", "" +TAG_DRY_CEREAL  );
                        }


                        // wednesdaymenu.put(TAG_B_BREAD, B_BREAD);
                        if (B_BREAD!=null&&!B_BREAD.isEmpty())

                        {
                            wednesdaymenuHashMap.put(TAG_B_BREAD, B_BREAD);
                            //Log.d("check  : ", "" +TAG_DRY_CEREAL  );
                        }


                        // wednesdaymenu.put(TAG_L_SALAD, L_SALAD);
                        if (L_SALAD!=null&&!L_SALAD.isEmpty())

                        {
                            wednesdaymenuHashMap.put(TAG_L_SALAD, L_SALAD);
                            //Log.d("check  : ", "" +TAG_DRY_CEREAL  );
                        }


                        //  wednesdaymenu.put(TAG_L_RICE, L_RICE);
                        if (L_RICE!=null&&!L_RICE.isEmpty())

                        {
                            wednesdaymenuHashMap.put(TAG_L_RICE, L_RICE);
                            //Log.d("check  : ", "" +TAG_DRY_CEREAL  );
                        }

                        // wednesdaymenu.put(TAG_L_DAL, L_DAL);

                        if (L_DAL!=null&&!L_DAL.isEmpty())

                        {
                            wednesdaymenuHashMap.put(TAG_L_DAL, L_DAL);
                            //Log.d("check  : ", "" +TAG_DRY_CEREAL  );
                        }

                        // wednesdaymenu.put(TAG_L_PANEER, L_PANEER);

                        if (L_PANEER!=null&&!L_PANEER.isEmpty())

                        {
                            wednesdaymenuHashMap.put(TAG_L_PANEER, L_PANEER);
                            //Log.d("check  : ", "" +TAG_DRY_CEREAL  );
                        }


                        //wednesdaymenu.put(TAG_L_SEMI, L_SEMI);

                        if (L_SEMI!=null&&!L_SEMI.isEmpty())

                        {
                            wednesdaymenuHashMap.put(TAG_L_SEMI, L_SEMI);
                            //Log.d("check  : ", "" +TAG_DRY_CEREAL  );
                        }


                        //wednesdaymenu.put(TAG_L_GRAVY, L_GRAVY);

                        if (L_GRAVY!=null&&!L_GRAVY.isEmpty())

                        {
                            wednesdaymenuHashMap.put(TAG_L_GRAVY, L_GRAVY);
                            //Log.d("check  : ", "" +TAG_DRY_CEREAL  );
                        }


                        //wednesdaymenu.put(TAG_L_DESSERT, L_DESSERT);

                        if (L_DESSERT!=null&&!L_DESSERT.isEmpty())

                        {
                            wednesdaymenuHashMap.put(TAG_L_DESSERT, L_DESSERT);
                            //Log.d("check  : ", "" +TAG_DRY_CEREAL  );
                        }


                        // wednesdaymenu.put(TAG_L_BREAD, L_BREAD);

                        if (L_BREAD!=null&&!L_BREAD.isEmpty())

                        {
                            wednesdaymenuHashMap.put(TAG_L_BREAD, L_BREAD);
                            //Log.d("check  : ", "" +TAG_DRY_CEREAL  );
                        }

                        //wednesdaymenu.put(TAG_L_CURD, L_CURD);

                        if (L_CURD!=null&&!L_CURD.isEmpty())

                        {
                            wednesdaymenuHashMap.put(TAG_L_CURD, L_CURD);
                            //Log.d("check  : ", "" +TAG_DRY_CEREAL  );
                        }


                        //wednesdaymenu.put(TAG_SNACKS, SNACKS);

                        if (SNACKS!=null&&!SNACKS.isEmpty())

                        {
                            wednesdaymenuHashMap.put(TAG_SNACKS, SNACKS);
                            //Log.d("check  : ", "" +TAG_DRY_CEREAL  );
                        }

                        // wednesdaymenu.put(TAG_DRINK, DRINK);

                        if (DRINK!=null&&!DRINK.isEmpty())

                        {
                            wednesdaymenuHashMap.put(TAG_DRINK, DRINK);
                            //Log.d("check  : ", "" +TAG_DRY_CEREAL  );
                        }

                        //wednesdaymenu.put(TAG_D_SALAD, D_SALAD);

                        if (D_SALAD!=null&&!D_SALAD.isEmpty())

                        {
                            wednesdaymenuHashMap.put(TAG_D_SALAD, D_SALAD);
                            //Log.d("check  : ", "" +TAG_DRY_CEREAL  );
                        }

                        // wednesdaymenu.put(TAG_D_RICE, D_RICE);

                        if (D_RICE!=null&&!D_RICE.isEmpty())

                        {
                            wednesdaymenuHashMap.put(TAG_D_RICE, D_RICE);
                            //Log.d("check  : ", "" +TAG_DRY_CEREAL  );
                        }

                        // wednesdaymenu.put(TAG_D_DAL, D_DAL);
                        if (D_DAL!=null&&!D_DAL.isEmpty())

                        {
                            wednesdaymenuHashMap.put(TAG_D_DAL, D_DAL);
                            //Log.d("check  : ", "" +TAG_DRY_CEREAL  );
                        }

                        //wednesdaymenu.put(TAG_D_PANEER, D_PANEER);
                        if (D_PANEER!=null&&!D_PANEER.isEmpty())

                        {
                            wednesdaymenuHashMap.put(TAG_D_PANEER, D_PANEER);
                            //Log.d("check  : ", "" +TAG_DRY_CEREAL  );
                        }

                        //wednesdaymenu.put(TAG_D_SEMI, D_SEMI);

                        if (D_SEMI!=null&&!D_SEMI.isEmpty())

                        {
                            wednesdaymenuHashMap.put(TAG_D_SEMI, D_SEMI);
                            //Log.d("check  : ", "" +TAG_DRY_CEREAL  );
                        }


                        //wednesdaymenu.put(TAG_D_GRAVY, D_GRAVY);

                        if (D_GRAVY!=null&&!D_GRAVY.isEmpty())

                        {
                            wednesdaymenuHashMap.put(TAG_D_GRAVY, D_GRAVY);
                            //Log.d("check  : ", "" +TAG_DRY_CEREAL  );
                        }
                        // wednesdaymenu.put(TAG_D_DESSERT, D_DESSERT);

                        if (D_DESSERT!=null&&!D_DESSERT.isEmpty())

                        {
                            wednesdaymenuHashMap.put(TAG_D_DESSERT, D_DESSERT);
                            //Log.d("check  : ", "" +TAG_DRY_CEREAL  );
                        }

                        // wednesdaymenu.put(TAG_D_BREAD, D_BREAD);

                        if (D_BREAD!=null&&!D_BREAD.isEmpty())

                        {
                            wednesdaymenuHashMap.put(TAG_D_BREAD, D_BREAD);
                            //Log.d("check  : ", "" +TAG_DRY_CEREAL  );
                        }
                        // wednesdaymenu.put(TAG_D_CURD, D_CURD);

                        if (D_CURD!=null&&!D_CURD.isEmpty())

                        {
                            wednesdaymenuHashMap.put(TAG_D_CURD, D_CURD);
                            //Log.d("check  : ", "" +TAG_DRY_CEREAL  );
                        }
        ...
        protected void onPostExecute(Boolean aVoid) {
            ...
            dryCereal.setText(wednesdaymenuHashMap.get(TAG_DRY_CEREAL));
            drinkOne.setText(wednesdaymenuHashMap.get(TAG_DRINK_ONE));
            drinkTwo.setText(wednesdaymenuHashMap.get(TAG_DRINK_TWO));
            main.setText(wednesdaymenuHashMap.get(TAG_MAIN));
            accompaniment.setText(wednesdaymenuHashMap.get(TAG_ACCOMPANIMENT));
            bread.setText(wednesdaymenuHashMap.get(TAG_B_BREAD));

            lSalad.setText(wednesdaymenuHashMap.get(TAG_L_SALAD));
            lRice.setText(wednesdaymenuHashMap.get(TAG_L_RICE));
            lDal.setText(wednesdaymenuHashMap.get(TAG_L_DAL));
            lPaneer.setText(wednesdaymenuHashMap.get(TAG_L_PANEER));
            lSemi.setText(wednesdaymenuHashMap.get(TAG_L_SEMI));
            lGravy.setText(wednesdaymenuHashMap.get(TAG_L_GRAVY));
            lDessert.setText(wednesdaymenuHashMap.get(TAG_L_DESSERT));
            lBread.setText(wednesdaymenuHashMap.get(TAG_L_BREAD));
            lCurd.setText(wednesdaymenuHashMap.get(TAG_L_CURD));

            snacks.setText(wednesdaymenuHashMap.get(TAG_SNACKS));
            drink.setText(wednesdaymenuHashMap.get(TAG_DRINK));

            dSalad.setText(wednesdaymenuHashMap.get(TAG_D_SALAD));
            dRice.setText(wednesdaymenuHashMap.get(TAG_D_RICE));
            dDal.setText(wednesdaymenuHashMap.get(TAG_D_DAL));
            dPaneer.setText(wednesdaymenuHashMap.get(TAG_D_PANEER));
            dSemi.setText(wednesdaymenuHashMap.get(TAG_D_SEMI));
            dGravy.setText(wednesdaymenuHashMap.get(TAG_D_GRAVY));
            dDessert.setText(wednesdaymenuHashMap.get(TAG_D_DESSERT));
            dBread.setText(wednesdaymenuHashMap.get(TAG_D_BREAD));
            dCurd.setText(wednesdaymenuHashMap.get(TAG_D_CURD));
