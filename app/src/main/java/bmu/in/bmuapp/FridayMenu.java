...
public class FridayMenu extends AppCompatActivity {
    ...
    HashMap<String, String> fridaymenuHashMap;        //new
    ...
    private class GetContacts extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... arg0) {
            ...
            if (jsonStr != null) {
                ...
                try {
                    ...
                    Log.d("check 12 : ", "" +fridaymenu  );

                    fridaymenuHashMap = new HashMap<String, String>();
                    ...
                    for (int i = 0; i < fridaymenu.length(); i++) {
                        ...
                        {
                            fridaymenuHashMap.put(TAG_DRY_CEREAL, DRY_CEREAL);
                       ...
                       // fridaymenu.put(TAG_DRINK_ONE, DRINK_ONE);
                        ...
                        {
                            fridaymenuHashMap.put(TAG_DRINK_ONE, DRINK_ONE);
                            //Log.d("check  : ", "" +TAG_DRY_CEREAL  );
                        }
                        ...
                        {
                            fridaymenuHashMap.put(TAG_DRINK_TWO, DRINK_TWO);
                            //Log.d("check  : ", "" +TAG_DRY_CEREAL  );
                        }
                       ...
                       // fridaymenu.put(TAG_MAIN, MAIN);
                        ...
                        {
                            fridaymenuHashMap.put(TAG_MAIN, MAIN);
                            //Log.d("check  : ", "" +TAG_DRY_CEREAL  );
                        }
                       // fridaymenu.put(TAG_ACCOMPANIMENT, ACCOMPANIMENT);
                        ...
                        {
                            fridaymenuHashMap.put(TAG_ACCOMPANIMENT, ACCOMPANIMENT);
                            //Log.d("check  : ", "" +TAG_DRY_CEREAL  );
                        }
                       ...
                       // fridaymenu.put(TAG_B_BREAD, B_BREAD);
                        ...
                        {
                            fridaymenuHashMap.put(TAG_B_BREAD, B_BREAD);
                            //Log.d("check  : ", "" +TAG_DRY_CEREAL  );
                        }
                       ...
                       // fridaymenu.put(TAG_L_SALAD, L_SALAD);
                        ...
                        {
                            fridaymenuHashMap.put(TAG_L_SALAD, L_SALAD);
                            //Log.d("check  : ", "" +TAG_DRY_CEREAL  );
                        }
                      ...
                      //  fridaymenu.put(TAG_L_RICE, L_RICE);
                        ...
                        {
                            fridaymenuHashMap.put(TAG_L_RICE, L_RICE);
                            //Log.d("check  : ", "" +TAG_DRY_CEREAL  );
                        }
                       ...
                       // fridaymenu.put(TAG_L_DAL, L_DAL);
                        ...
                        {
                            fridaymenuHashMap.put(TAG_L_DAL, L_DAL);
                            //Log.d("check  : ", "" +TAG_DRY_CEREAL  );
                        }
                       ...
                       // fridaymenu.put(TAG_L_PANEER, L_PANEER);
                        ...
                        {
                            fridaymenuHashMap.put(TAG_L_PANEER, L_PANEER);
                            //Log.d("check  : ", "" +TAG_DRY_CEREAL  );
                        }
                        ...
                        {
                            fridaymenuHashMap.put(TAG_L_SEMI, L_SEMI);
                            //Log.d("check  : ", "" +TAG_DRY_CEREAL  );
                        }
                        ...
                        {
                            fridaymenuHashMap.put(TAG_L_GRAVY, L_GRAVY);
                            //Log.d("check  : ", "" +TAG_DRY_CEREAL  );
                        }
                        ...
                        {
                            fridaymenuHashMap.put(TAG_L_DESSERT, L_DESSERT);
                            //Log.d("check  : ", "" +TAG_DRY_CEREAL  );
                        }
                       ...
                       // fridaymenu.put(TAG_L_BREAD, L_BREAD);
                        ...
                        {
                            fridaymenuHashMap.put(TAG_L_BREAD, L_BREAD);
                            //Log.d("check  : ", "" +TAG_DRY_CEREAL  );
                        }
                        ...
                        {
                            fridaymenuHashMap.put(TAG_L_CURD, L_CURD);
                            //Log.d("check  : ", "" +TAG_DRY_CEREAL  );
                        }
                        ...
                        {
                            fridaymenuHashMap.put(TAG_SNACKS, SNACKS);
                            //Log.d("check  : ", "" +TAG_DRY_CEREAL  );
                        }
                       ...
                       // fridaymenu.put(TAG_DRINK, DRINK);
                        ...
                        {
                            fridaymenuHashMap.put(TAG_DRINK, DRINK);
                            //Log.d("check  : ", "" +TAG_DRY_CEREAL  );
                        }
                        ...
                        {
                            fridaymenuHashMap.put(TAG_D_SALAD, D_SALAD);
                            //Log.d("check  : ", "" +TAG_DRY_CEREAL  );
                        }
                       ...
                       // fridaymenu.put(TAG_D_RICE, D_RICE);
                        ...
                        {
                            fridaymenuHashMap.put(TAG_D_RICE, D_RICE);
                            //Log.d("check  : ", "" +TAG_DRY_CEREAL  );
                        }
                       ...
                       // fridaymenu.put(TAG_D_DAL, D_DAL);
                        ...
                        {
                            fridaymenuHashMap.put(TAG_D_DAL, D_DAL);
                            //Log.d("check  : ", "" +TAG_DRY_CEREAL  );
                        }
                        ...
                        {
                            fridaymenuHashMap.put(TAG_D_PANEER, D_PANEER);
                            //Log.d("check  : ", "" +TAG_DRY_CEREAL  );
                        }
                        ...
                        {
                            fridaymenuHashMap.put(TAG_D_SEMI, D_SEMI);
                            //Log.d("check  : ", "" +TAG_DRY_CEREAL  );
                        }
                        ...
                        {
                            fridaymenuHashMap.put(TAG_D_GRAVY, D_GRAVY);
                            //Log.d("check  : ", "" +TAG_DRY_CEREAL  );
                        }
                       // fridaymenu.put(TAG_D_DESSERT, D_DESSERT);
                        ...
                        {
                            fridaymenuHashMap.put(TAG_D_DESSERT, D_DESSERT);
                            //Log.d("check  : ", "" +TAG_DRY_CEREAL  );
                        }
                       ...
                       // fridaymenu.put(TAG_D_BREAD, D_BREAD);
                        ...
                        {
                            fridaymenuHashMap.put(TAG_D_BREAD, D_BREAD);
                            //Log.d("check  : ", "" +TAG_DRY_CEREAL  );
                        }
                       // fridaymenu.put(TAG_D_CURD, D_CURD);
                        ...
                        {
                            fridaymenuHashMap.put(TAG_D_CURD, D_CURD);
                            //Log.d("check  : ", "" +TAG_DRY_CEREAL  );
                        }
        ...
        protected void onPostExecute(Boolean aVoid) {
            ...
            dryCereal.setText(fridaymenuHashMap.get(TAG_DRY_CEREAL));
            drinkOne.setText(fridaymenuHashMap.get(TAG_DRINK_ONE));
            drinkTwo.setText(fridaymenuHashMap.get(TAG_DRINK_TWO));
            main.setText(fridaymenuHashMap.get(TAG_MAIN));
            accompaniment.setText(fridaymenuHashMap.get(TAG_ACCOMPANIMENT));
            bread.setText(fridaymenuHashMap.get(TAG_B_BREAD));

            lSalad.setText(fridaymenuHashMap.get(TAG_L_SALAD));
            lRice.setText(fridaymenuHashMap.get(TAG_L_RICE));
            lDal.setText(fridaymenuHashMap.get(TAG_L_DAL));
            lPaneer.setText(fridaymenuHashMap.get(TAG_L_PANEER));
            lSemi.setText(fridaymenuHashMap.get(TAG_L_SEMI));
            lGravy.setText(fridaymenuHashMap.get(TAG_L_GRAVY));
            lDessert.setText(fridaymenuHashMap.get(TAG_L_DESSERT));
            lBread.setText(fridaymenuHashMap.get(TAG_L_BREAD));
            lCurd.setText(fridaymenuHashMap.get(TAG_L_CURD));

            snacks.setText(fridaymenuHashMap.get(TAG_SNACKS));
            drink.setText(fridaymenuHashMap.get(TAG_DRINK));

            dSalad.setText(fridaymenuHashMap.get(TAG_D_SALAD));
            dRice.setText(fridaymenuHashMap.get(TAG_D_RICE));
            dDal.setText(fridaymenuHashMap.get(TAG_D_DAL));
            dPaneer.setText(fridaymenuHashMap.get(TAG_D_PANEER));
            dSemi.setText(fridaymenuHashMap.get(TAG_D_SEMI));
            dGravy.setText(fridaymenuHashMap.get(TAG_D_GRAVY));
            dDessert.setText(fridaymenuHashMap.get(TAG_D_DESSERT));
            dBread.setText(fridaymenuHashMap.get(TAG_D_BREAD));
            dCurd.setText(fridaymenuHashMap.get(TAG_D_CURD));
